...
for i in range(total_passwords):
    ...
    for ch in password:
        ...
        # Character 1 se jyada baar ho
        # aur list me pehle se na ho
    ...
    if spaces > 0:
        print("Spaces Found      : Yes")
    else:
        print("Spaces Found      : No")
